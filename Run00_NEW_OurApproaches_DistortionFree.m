...
title(['Fig. 1a: Comparison of four proposed approaches, SNR = ' int2str(20*log10(1/sigma))],'FontSize', fontSize, 'FontWeight', 'bold')
...
title('Fig. 1b: Comparison of exact and estimated frequency','FontSize', fontSize, 'FontWeight', 'bold')
legend('exact frequency', 'estimated frequency')
